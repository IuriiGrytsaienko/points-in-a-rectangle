...
let rectangle1 = {x1: initCoordinate(), y1: initCoordinate(), x2: initCoordinate(), y2: initCoordinate()};
let rectangle2 = {x1: initCoordinate(), y1: initCoordinate(), x2: initCoordinate(), y2: initCoordinate()};
